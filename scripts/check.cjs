...
const wardrobe = read('app/dist/wardrobe.js')
const wardrobeCss = read('app/dist/assets/wardrobe.css')
...
check('model and garment libraries are linked', html.includes('wardrobe.js') && html.includes('wardrobe.css'))
check('diverse model presets are available', wardrobe.includes("['Morgan', '3XL'") && wardrobe.includes("['Casey', '4XL'"))
check('local imports use IndexedDB', wardrobe.includes("indexedDB.open(DB_NAME") && wardrobe.includes("readAsDataURL"))
check('try-on studio has responsive layout', wardrobeCss.includes('.tryon-workspace') && wardrobeCss.includes('@media(max-width:820px)'))
