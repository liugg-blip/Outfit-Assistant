...
check('reference mannequin stance is retained', silhouettes.male.bottom.includes('L 133,426') && silhouettes.female.bottom.includes('L 132,428'))
check('hands are part of the body silhouette', silhouettes.male.neck.includes('M 67,187') && silhouettes.female.neck.includes('M 72,184'))
